...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        layoutWidget7 = new QWidget(Local_Scharr_Histogram);
        ...
        Local_Scharr_histogram_slider = new QSlider(layoutWidget7);
        ...
        Local_Scharr_histogram_lcdNumber = new QLCDNumber(layoutWidget7);
